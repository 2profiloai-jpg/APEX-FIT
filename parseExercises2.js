...
function guessCategory(line) {
    ...
    if (line.includes('rematore') || line.includes('pull') || line.includes('chin') || line.includes('lat ') || line.includes('row') || line.includes('trazion') || line.includes('scrollate')) return 'Schiena';
