...
export const EXERCISE_LIBRARY: Exercise[] = [
  ...
  { id: 'n35', name: 'Yates Row', category: 'Schiena', targetMuscles: ['Schiena'], equipment: 'Bilanciere', type: 'Composto', proNote: 'Presa supina, busto 45°, gran dorsale basso.', instructions: '1. Presa inversa (supina) e meno piegato.\n2. Tira al basso addome.', videoUrl: 'https://www.youtube.com/embed/TAH0ATzmw_E' },
  { id: 'n36', name: 'Scrollate (Shrugs)', category: 'Schiena', targetMuscles: ['Schiena'], equipment: 'Bilanciere', type: 'Composto', proNote: 'Fuoco sui trapezi superiori.', instructions: '1. Alza le spalle più che puoi.', videoUrl: 'https://www.youtube.com/embed/5OqbLUty7j8' },
  ...
  { id: 'n38', name: 'Curl con bilanciere EZ', category: 'Bicipiti', targetMuscles: ['Bicipiti'], equipment: 'Bilanciere', type: 'Composto', proNote: 'Delicato per i polsi rispetto al dritto.', instructions: '1. Usa la barra EZ, fletti le braccia.', videoUrl: 'https://www.youtube.com/embed/6YH1xZZ43Vw' },
  { id: 'n39', name: 'Spider Curl (busto in appoggio)', category: 'Bicipiti', targetMuscles: ['Bicipiti'], equipment: 'Bilanciere', type: 'Composto', proNote: 'Nessun cheating, massima contrazione.', instructions: '1. Piegato su panca, braccia penzolanti.\n2. Tira portando i palmi alle spalle.', videoUrl: 'https://www.youtube.com/embed/Je5hYZ_lIPM' },
  { id: 'n40', name: 'French Press (Skull Crushers)', category: 'Tricipiti', targetMuscles: ['Tricipiti'], equipment: 'Bilanciere', type: 'Composto', proNote: 'Lavoro enorme sul capo lungo.', instructions: '1. Da sdraiato, piega i gomiti arrivando alla fronte.', videoUrl: 'https://www.youtube.com/embed/a_9KtGXT0rI' },
  { id: 'n41', name: 'JM Press', category: 'Tricipiti', targetMuscles: ['Tricipiti'], equipment: 'Bilanciere', type: 'Composto', proNote: 'Ibrido panca e french press molto efficace.', instructions: '1. Scendi come una estensione ma chiudendoti.', videoUrl: 'https://www.youtube.com/embed/jmgz4ILVveM' },

  { id: 'n42', name: 'Spinte manubri piana/inclinata', category: 'Petto', targetMuscles: ['Petto'], equipment: 'Manubri', type: 'Composto', proNote: 'Sintesi ROM ed equilibrio per il petto.', instructions: '1. Spingi i manubri verso l\'alto.', videoUrl: 'https://www.youtube.com/embed/WDTlE6G6ook' },
  { id: 'n43', name: 'Croci su panca (varie inclinazioni)', category: 'Petto', targetMuscles: ['Petto'], equipment: 'Manubri', type: 'Composto', proNote: 'Aperture e flys per grande allungamento.', instructions: '1. Forma un arco abbracciando all\'esterno.', videoUrl: 'https://www.youtube.com/embed/E4fBCLKbldo' },
  { id: 'n44', name: 'Svend Press con manubrio', category: 'Petto', targetMuscles: ['Petto'], equipment: 'Manubri', type: 'Composto', proNote: 'Tensione Isometrica.', instructions: '1. Spingi il manubrio strizzando il petto dal centro.', videoUrl: 'https://www.youtube.com/embed/xXURCvkZ_2c' },
  ...
  { id: 'n46', name: 'Shoulder Press (paralleli/proni)', category: 'Spalle', targetMuscles: ['Spalle'], equipment: 'Manubri', type: 'Composto', proNote: 'Massa basilare spalle.', instructions: '1. Spingi i manubri dritti in alto.', videoUrl: 'https://www.youtube.com/embed/8XbOgK_GJ4o' },
  { id: 'n47', name: 'Alzate laterali manubri', category: 'Spalle', targetMuscles: ['Spalle'], equipment: 'Manubri', type: 'Composto', proNote: 'Allargano visivamente la spalla.', instructions: '1. Solleva le braccia ai lati a T.', videoUrl: 'https://www.youtube.com/embed/FDCwcG71Yi0' },
  { id: 'n48', name: 'Alzate frontali manubri', category: 'Spalle', targetMuscles: ['Spalle'], equipment: 'Manubri', type: 'Composto', proNote: 'Fascio anteriore puro.', instructions: '1. Solleva davanti fino a occhi.', videoUrl: 'https://www.youtube.com/embed/ruDwJITOt4A' },
  { id: 'n49', name: 'Alzate a 90° (posteriore)', category: 'Spalle', targetMuscles: ['Spalle'], equipment: 'Manubri', type: 'Composto', proNote: 'Spalle tonde e salute posturale.', instructions: '1. Busto parallelo, apri braccia indietro.', videoUrl: 'https://www.youtube.com/embed/9G4MI1pjmJM' },
  { id: 'n50', name: 'L-Fly (rotatori spalla)', category: 'Spalle', targetMuscles: ['Spalle'], equipment: 'Manubri', type: 'Composto', proNote: 'Salute cuffia dei rotatori.', instructions: '1. Ruota esternamente mantenendo il gomito vicino.', videoUrl: 'https://www.youtube.com/embed/_82ZNsyhLKo' },
  { id: 'n51', name: 'Rematore singolo su panca', category: 'Schiena', targetMuscles: ['Schiena'], equipment: 'Manubri', type: 'Composto', proNote: 'Monolaterale profondo.', instructions: '1. Un ginocchio su panca, tira col braccio libero.', videoUrl: 'https://www.youtube.com/embed/-ebafKeAmXs' },
  { id: 'n52', name: 'Seal Row con manubri', category: 'Schiena', targetMuscles: ['Schiena'], equipment: 'Manubri', type: 'Composto', proNote: 'Senza carico sui lombari.', instructions: '1. Sdraiato pancia in giù, tira i manubri.', videoUrl: 'https://www.youtube.com/embed/-ebafKeAmXs' },
  { id: 'n53', name: 'Scrollate con manubri', category: 'Schiena', targetMuscles: ['Schiena'], equipment: 'Manubri', type: 'Composto', proNote: 'Trapezi bilanciati lati.', instructions: '1. Alza le spalle con pesi a lato in neutro.', videoUrl: 'https://www.youtube.com/embed/5OqbLUty7j8' },
  { id: 'n54', name: 'Curl alternato', category: 'Bicipiti', targetMuscles: ['Bicipiti'], equipment: 'Manubri', type: 'Composto', proNote: 'Massa bicipitale asimmetrica.', instructions: '1. Fletti alternando lato.', videoUrl: 'https://www.youtube.com/embed/I7QaAuqlE6I' },
  ...
  { id: 'n56', name: 'Curl su panca inclinata', category: 'Bicipiti', targetMuscles: ['Bicipiti'], equipment: 'Manubri', type: 'Composto', proNote: 'Estremo allungamento partenza del bicipite.', instructions: '1. Stenditi, braccia tirate giù in dietro e fletti.', videoUrl: 'https://www.youtube.com/embed/8m6Lrr5do1c' },
  { id: 'n57', name: 'Curl concentrato', category: 'Bicipiti', targetMuscles: ['Bicipiti'], equipment: 'Manubri', type: 'Composto', proNote: 'Creazione del picco del muscolo.', instructions: '1. Gomito interno al ginocchio scendi e isola.', videoUrl: 'https://www.youtube.com/embed/Wo1fCvmpl60' },
  ...
  { id: 'n59', name: 'Tate Press (tricipiti)', category: 'Tricipiti', targetMuscles: ['Tricipiti'], equipment: 'Manubri', type: 'Composto', proNote: 'Focus parte esterna tricipiti.', instructions: '1. Gomiti in fuori fletti ad incrociare in petto.', videoUrl: 'https://www.youtube.com/embed/iqkV3W1D_Kw' },
  { id: 'n60', name: 'Kickback (tricipiti)', category: 'Tricipiti', targetMuscles: ['Tricipiti'], equipment: 'Manubri', type: 'Composto', proNote: 'Picco di chiusura in estensione.', instructions: '1. Estendi solo l\'avambraccio indietro.', videoUrl: 'https://www.youtube.com/embed/5S_FTJiW6h0' },
  { id: 'n61', name: 'Estensioni dietro nuca', category: 'Tricipiti', targetMuscles: ['Tricipiti'], equipment: 'Manubri', type: 'Composto', proNote: 'Tensione grande tricipite.', instructions: '1. Tieni un disco o manubrio dietro il collo ad estenderlo su.', videoUrl: 'https://www.youtube.com/embed/o-y4gSRg3zo' },

  { id: 'n62', name: 'Goblet Squat', category: 'Gambe', targetMuscles: ['Gambe'], equipment: 'Manubri', type: 'Composto', proNote: 'Base di tecnica profonda.', instructions: '1. Manubrio stretto a coppa, scendi a fondo squat.', videoUrl: 'https://www.youtube.com/embed/j3HmSPkDvKw' },
  { id: 'n63', name: 'Affondi camminati', category: 'Gambe', targetMuscles: ['Gambe'], equipment: 'Manubri', type: 'Composto', proNote: 'Metabolismo alto gambe e glutei.', instructions: '1. Passo dopo passo sprofondando il ginocchio dietro.', videoUrl: 'https://www.youtube.com/embed/bzvV82PhjtI' },
  { id: 'n64', name: 'Affondi laterali', category: 'Gambe', targetMuscles: ['Gambe'], equipment: 'Manubri', type: 'Composto', proNote: 'Flessibilità adduttori e glutei.', instructions: '1. Paso lato, giù su unica gamba di appoggio.', videoUrl: 'https://www.youtube.com/embed/pX77ux9avK0' },
  { id: 'n65', name: 'Stacco rumeno manubri', category: 'Gambe', targetMuscles: ['Gambe'], equipment: 'Manubri', type: 'Composto', proNote: 'Facilita la non compressione schiena avanti.', instructions: '1. Scivola giù manubri rasenti la coscia a schiena incassata dritta.', videoUrl: 'https://www.youtube.com/embed/pU2MN8k433Y' },
  ...
  { id: 'n67', name: 'Bulgarian Split Squat 2 manubri', category: 'Gambe', targetMuscles: ['Gambe'], equipment: 'Manubri', type: 'Composto', proNote: 'Gambe morte e gluteo re d\'isolamento carico.', instructions: '1. Piede su, due pesate pesanti.', videoUrl: 'https://www.youtube.com/embed/H0AP-lAZEbQ' },
  { id: 'n68', name: 'Pistol Squat manubrio', category: 'Gambe', targetMuscles: ['Gambe'], equipment: 'Manubri', type: 'Composto', proNote: 'Mestierante monopodialità calisthenica.', instructions: '1. Una sola gamba, profondo giù steso.', videoUrl: 'https://www.youtube.com/embed/2usDgj79oCc' },
  ...
  { id: 'n70', name: 'Chest Press', category: 'Petto', targetMuscles: ['Petto'], equipment: 'Macchinario', type: 'Composto', proNote: 'Isolamento petto al cedimento.', instructions: '1. Spingi la macchina controllato.', videoUrl: 'https://www.youtube.com/embed/lAkcFUulVn4' },
  { id: 'n71', name: 'Pec Deck (Butterfly)', category: 'Petto', targetMuscles: ['Petto'], equipment: 'Macchinario', type: 'Composto', proNote: 'Aperture e fly massimi al macchinario petto.', instructions: '1. Esegui apertura strizzando il pettorale in mezzo.', videoUrl: 'https://www.youtube.com/embed/6dExVifvwR8' },
  { id: 'n72', name: 'Chest Press convergente', category: 'Petto', targetMuscles: ['Petto'], equipment: 'Macchinario', type: 'Composto', proNote: 'Fascio stretto di fine range.', instructions: '1. Come spinta ma stringendo verso il centro in alto.', videoUrl: 'https://www.youtube.com/embed/lAkcFUulVn4' },
  { id: 'n73', name: 'Shoulder Press Machine', category: 'Spalle', targetMuscles: ['Spalle'], equipment: 'Macchinario', type: 'Composto', proNote: 'Super isolamento in sicurezza spalla per cedimento.', instructions: '1. Spinta altisonante stazionata da sedersi comodamente.', videoUrl: 'https://www.youtube.com/embed/6v4nrRVySj0' },
  { id: 'n74', name: 'Lateral Raise Machine', category: 'Spalle', targetMuscles: ['Spalle'], equipment: 'Macchinario', type: 'Composto', proNote: 'Deltoidi tondi per isolare ai manicotti laterali.', instructions: '1. Alza tenendo le macchine su spalle di lato.', videoUrl: 'https://www.youtube.com/embed/_82ZNsyhLKo' },
  { id: 'n75', name: 'Dip Machine', category: 'Petto', targetMuscles: ['Petto'], equipment: 'Macchinario', type: 'Composto', proNote: 'Tricipiti e petto inferiore a carico stazionario fisso seduto.', instructions: '1. Spingi a fondo flettendo giu le maniglo.', videoUrl: 'https://www.youtube.com/embed/t7e4PTG-9Jg' },
  ...
  { id: 'n77', name: 'Pulley basso (Seated Row)', category: 'Schiena', targetMuscles: ['Schiena'], equipment: 'Macchinario', type: 'Composto', proNote: 'Spessore basso per V shaper grande.', instructions: '1. Tira indietro basso ad addome mantenendo estensione dritta dorso.', videoUrl: 'https://www.youtube.com/embed/qaR7MJw1AOY' },
  { id: 'n78', name: 'Vertical Row', category: 'Schiena', targetMuscles: ['Schiena'], equipment: 'Macchinario', type: 'Composto', proNote: 'Spessore massimo centrale schiena in isolamento.', instructions: '1. Impugna e sfonda dietro la schiena le braccia con stazionarietà pancia appoggiata.', videoUrl: 'https://www.youtube.com/embed/NL6Lqd6nU-g' },
  { id: 'n79', name: 'Pullover Machine', category: 'Schiena', targetMuscles: ['Schiena'], equipment: 'Macchinario', type: 'Composto', proNote: 'Costola magica per isolamento dorsale senza bicipiti.', instructions: '1. Tira ai fianchi il cuscinetto dietro collo spingendo ad ellisse a chiudere su ginocchio.', videoUrl: 'https://www.youtube.com/embed/_82ZNsyhLKo' },
  ...
  { id: 'n82', name: 'Leg Press 45°', category: 'Gambe', targetMuscles: ['Gambe'], equipment: 'Macchinario', type: 'Composto', proNote: 'Sfinimento quadricipiti enorme a carico stazionatiore altissimi.', instructions: '1. Appoggia intera schiena piegati profondi e spingi press fin quasi lock tesa.', videoUrl: 'https://www.youtube.com/embed/LMTyPl_oo38' },
  ...
  { id: 'n87', name: 'Glute Drive Machine', category: 'Gambe', targetMuscles: ['Gambe'], equipment: 'Macchinario', type: 'Composto', proNote: 'Hip Thrust isolato alla cinta grande confort macchinario dedicato e stabile pesantissimo!', instructions: '1. Allaccia cintura stretta e ponte sedere altissimo.', videoUrl: 'https://www.youtube.com/embed/IHk9Qn8ttX8' },
  { id: 'n88', name: 'Standing Calf Raise Machine', category: 'Gambe', targetMuscles: ['Gambe'], equipment: 'Macchinario', type: 'Composto', proNote: 'Isolamento massiccio per polpaccio sovrastato!', instructions: '1. Tendi polpacci molle punta piede rialzato con leva spalla poggia in piedi su gradino puleggio!', videoUrl: 'https://www.youtube.com/embed/xwszHjl2D40' },

  { id: 'n89', name: 'Cross-over alti / bassi', category: 'Petto', targetMuscles: ['Petto'], equipment: 'Cavi', type: 'Composto', proNote: 'Dettagli costali e contrazione muscolare al cavo incrociate spinge croci.', instructions: '1. Stringi cavo ai fianchi per petto basso.', videoUrl: 'https://www.youtube.com/embed/pb-_CiYSVMc' },
  { id: 'n90', name: 'Face Pull', category: 'Spalle', targetMuscles: ['Spalle'], equipment: 'Cavi', type: 'Composto', proNote: 'Stabilità posture e deltoide posteriori ai rotatori della cuffia!', instructions: '1. Tira al volto divaricando gomiti in fuori!', videoUrl: 'https://www.youtube.com/embed/aNdEEte9fBY' },
  { id: 'n91', name: 'Pull-down braccia tese', category: 'Schiena', targetMuscles: ['Schiena'], equipment: 'Cavi', type: 'Composto', proNote: 'Inizia al dorsale esclude bicipite isolamente puro grandorsale tendini!', instructions: '1. Mantenendo quasi tese abbassa asta ai fianchi.', videoUrl: 'https://www.youtube.com/embed/IfgUF3RbutE' },
  { id: 'n92', name: 'Pushdown tricipiti fune/barra', category: 'Tricipiti', targetMuscles: ['Tricipiti'], equipment: 'Cavi', type: 'Composto', proNote: 'Isolamento continuo in basso tricipiti ai cavi estensioni in distesa manubrio.', instructions: '1. Estendi ai lati della coscia in divaricata fune scesa stesa!', videoUrl: 'https://www.youtube.com/embed/A17vqyT5qsg' },
  { id: 'n93', name: 'Estensioni capo al cavo', category: 'Tricipiti', targetMuscles: ['Tricipiti'], equipment: 'Cavi', type: 'Composto', proNote: 'Tricipiti capo allungato esteso e spinta avanti per isolamento lunghi capi estensorio al fronte e sopra.', instructions: '1. Da dietro testa estendi cavo in corda avanti alzo.', videoUrl: 'https://www.youtube.com/embed/z-GYsUm3f9c' },
  { id: 'n94', name: 'Pull-through glutei', category: 'Gambe', targetMuscles: ['Gambe'], equipment: 'Cavi', type: 'Composto', proNote: 'Gambe estese e dorso incassato con forza di ponte fune a staccare da sotto i glutei pesati al cavo!', instructions: '1. Presa fune da dietro fra gambe spingendo in avanti e chiudendo anca contraendo forte chiappa.', videoUrl: 'https://www.youtube.com/embed/nLGrCSaKyME' },

  { id: 'n95', name: 'Dips parallele / muscle ups', category: 'Petto', targetMuscles: ['Petto', 'Tricipiti', 'Schiena'], equipment: 'Corpo Libero', type: 'Composto', proNote: 'Re della spinta e trazione corporee liberi calistenica massima di sollevamento in asse spalla e tricipite o sbarra!', instructions: '1. Esegui immersione petto giuso o sali esplosivamente la barra.', videoUrl: 'https://www.youtube.com/embed/t7e4PTG-9Jg' },
  { id: 'n96', name: 'Burpees / Mountain Climber', category: 'Core', targetMuscles: ['Core'], equipment: 'Corpo Libero', type: 'Composto', proNote: 'Metabolic shock cardio.', instructions: '1. A terra veloce poi esplosi su plank alternati rapidi ginochia in corsa ferma stesi.', videoUrl: 'https://www.youtube.com/embed/nkvGkfwjzqY' },

  { id: 'n97', name: 'Smith Machine Multi Squat/Press', category: 'Gambe', targetMuscles: ['Gambe'], equipment: 'Macchinario', type: 'Composto', proNote: 'Asse lineare stabile e bloccato in multipower e sicurezze!', instructions: '1. Usa asse per scendere o premere a piacere blocchi in maniglie spinte al petto inclinato.', videoUrl: 'https://www.youtube.com/embed/SDN28-YuxAU' },
  { id: 'n98', name: 'Kettlebell Swings / Snatch', category: 'Gambe', targetMuscles: ['Gambe'], equipment: 'Corpo Libero', type: 'Composto', proNote: 'Balistico puro spinto per esplosività e catena di forza postero gluteo femorali re.', instructions: '1. Non è spinta ma anca pendolante a balzo!', videoUrl: 'https://www.youtube.com/embed/M8mY-_thxDg' },
  { id: 'n99', name: 'Landmine Twist / Press', category: 'Core', targetMuscles: ['Core'], equipment: 'Bilanciere', type: 'Composto', proNote: 'Isometria torsionale addominale obliquo e spalle e spinte e dorso in bilanciere con angolo fissa cerniera pavimenti.', instructions: '1. Ruota le spalle o spingi.', videoUrl: 'https://www.youtube.com/embed/t7e4PTG-9Jg' },
  ...
  // SECRETS
  { id: 'n101', name: 'Rematore presa inversa', category: 'Schiena', targetMuscles: ['Schiena', 'Bicipiti'], equipment: 'Bilanciere', type: 'Composto', proNote: 'Aumenta il coinvolgimento dei bicipiti e del gran dorsale.', instructions: '1. Afferra il bilanciere con i palmi rivolti in avanti.', videoUrl: 'https://www.youtube.com/embed/ELjIQ5KHpJE' },
  { id: 'n102', name: 'Panca piana presa inversa', category: 'Petto', targetMuscles: ['Petto', 'Spalle'], equipment: 'Bilanciere', type: 'Composto', proNote: 'Meno stress sulle spalle, ottimo per tricipiti alti.', instructions: '1. Spingi con presa inversa (serve supporto per staccare).', videoUrl: 'https://www.youtube.com/embed/QZ6UXNj1B6k' },
  { id: 'n103', name: 'Curl a presa prona', category: 'Bicipiti', targetMuscles: ['Brachiale', 'Avambracci'], equipment: 'Bilanciere', type: 'Composto', proNote: 'Focus enorme sugli avambracci e brachiale.', instructions: '1. Usa presa pronata per sollevare il bilanciere.', videoUrl: 'https://www.youtube.com/embed/LtFlwrBHHZs' },
  { id: 'n104', name: 'Stacco con Trap Bar', category: 'Gambe', targetMuscles: ['Gambe', 'Core'], equipment: 'Trap Bar', type: 'Composto', proNote: 'Ibrido squat/stacco, salva molto la schiena bassa.', instructions: '1. Entra nella trap bar ed esegui una via di mezzo tra stacco e squat.', videoUrl: 'https://www.youtube.com/embed/vstyLAZSfnc' },
  { id: 'n105', name: 'Shoulder Press con presa neutra', category: 'Spalle', targetMuscles: ['Spalle'], equipment: 'Manubri', type: 'Composto', proNote: 'Salute massima delle spalle staccando i gomiti in avanti.', instructions: '1. Spingi tenendo i palmi rivolti tra loro.', videoUrl: 'https://www.youtube.com/embed/MANdy0Zc4kc' },
  { id: 'n106', name: 'Z-Curl', category: 'Bicipiti', targetMuscles: ['Bicipiti'], equipment: 'Manubri', type: 'Isolamento', proNote: 'Tensione costante e angoli insoliti.', instructions: '1. Fletti controllando al millimetro.', videoUrl: 'https://www.youtube.com/embed/1zevKZn_n1E' },
  ...
  { id: 'n108', name: 'Frog Pump', category: 'Gambe', targetMuscles: ['Glutei'], equipment: 'Corpo Libero', type: 'Isolamento', proNote: 'Attivazione gluteo fortissima e in isolamento.', instructions: '1. Pianta dei piedi combaciente e spingi su l\'anca come un hip thrust.', videoUrl: 'https://www.youtube.com/embed/y-yo8NBhs0k' },
  ...
  { id: 'n110', name: 'Dead Bug / Bird-Dog', category: 'Core', targetMuscles: ['Core'], equipment: 'Corpo Libero', type: 'Isolamento', proNote: 'Risolve i problemi di schiena e attiva il core asimmetrico.', instructions: '1. Estensioni opposte braccia gambe lenti a terra.', videoUrl: 'https://www.youtube.com/embed/gjOBXwBO9LM' },
  { id: 'n111', name: 'Curl bicipiti ai cavi', category: 'Bicipiti', targetMuscles: ['Bicipiti'], equipment: 'Cavi', type: 'Isolamento', proNote: 'Tensione costante durante tutto il range di movimento.', instructions: '1. In piedi, schiena dritta e gomiti incollati ai fianchi.\n2. Tira il cavo flettendo gli avambracci verso il petto.\n3. Rilascia lentamente resistendo al carico.', videoUrl: 'https://www.youtube.com/embed/UsY8ixNZ5qE' }
];
