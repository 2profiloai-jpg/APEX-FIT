...
const Stepper = ({ value, onChange, step = 1, min = 0, label, disabled }: { value: number, onChange: (v: number) => void, step?: number, min?: number, label?: string, disabled?: boolean }) => {
  return (
    <div className={cn("flex items-center justify-between bg-zinc-950 border border-zinc-800 rounded-lg p-1 h-12 transition-all", !disabled && "focus-within:border-blue-500 focus-within:ring-1 focus-within:ring-blue-500", disabled && "opacity-50 pointer-events-none")}>
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <div className="flex items-center gap-4 mt-2">
            <div className="flex items-center gap-2 text-blue-500 text-xl font-mono font-bold">
        ...
        <div className="flex flex-col items-end">
          {restTimer !== null ? (
            <div className="bg-blue-500 text-black px-4 py-2 rounded-2xl font-black text-xl animate-pulse">
          ...
          return (
            ...
            >
              <div className="p-4 bg-zinc-800/50 flex items-center justify-between">
                <h3 className="font-black uppercase tracking-tighter text-blue-500">{exerciseInfo?.name}</h3>
                  ...
                  <div key={setIdx} className={cn("grid grid-cols-12 gap-1 items-center transition-opacity", set.completed ? "opacity-50" : "opacity-100")}>
                    ...
                    <div className="col-span-2">
                      <select 
                        ...
                        className="w-full h-12 bg-zinc-950 border border-zinc-800 rounded-lg px-1 text-center font-mono text-sm appearance-none text-blue-500"
                        disabled={set.completed}
                      >
                    ...
                    <div className="col-span-1 flex justify-center">
                      <button 
                        ...
                        className={cn(
                          ...
                          set.completed ? "bg-blue-500 text-black" : "bg-zinc-800 text-zinc-500 hover:bg-zinc-700"
                        )}
                      >
          ...
          >
            ...
            <div className="space-y-4 mb-6">
              <input 
                ...
                className="w-full bg-zinc-900 border border-zinc-800 rounded-2xl py-4 px-6 font-black uppercase tracking-tighter text-sm focus:ring-1 ring-blue-500 outline-none"
              />
                ...
                {['Petto', 'Schiena', 'Gambe', 'Spalle', 'Bicipiti', 'Tricipiti', 'Core'].map(cat => (
                  <button 
                    ...
                    className={cn(
                      ...
                      pickerCategory === cat 
                        ? "bg-blue-500 text-black border-blue-500 shadow-[0_0_10px_rgba(59,130,246,0.2)]" 
                        : "bg-zinc-900 border-zinc-800 text-zinc-500 hover:text-blue-500 hover:border-blue-500"
                    )}
                  >
                    {cat}
                  </button>
            ...
            <div className="space-y-3 overflow-y-auto pb-20 flex-1">
              {EXERCISE_LIBRARY.filter(ex => {
                ...
                <button 
                  ...
                  className="w-full bg-zinc-900 border border-zinc-800 p-5 rounded-2xl text-left flex items-center justify-between hover:border-blue-500 transition-colors"
                >
                  <div>
